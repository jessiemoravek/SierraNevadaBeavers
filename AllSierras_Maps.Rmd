...
#make sure it's the right size
highRisk_Streamshq <- extend(highRisk_Streamshq, waterStorage)

#save as raster
writeRaster(highRisk_Streamshq, "highRiskHighQual.tif", overwrite=T)

#read in your data 
highRiskHighQual <- rast("highRiskHighQual.tif")
waterStorage <- rast("waterStorage.tif")
waterStorage[(waterStorage[] == 0)] <- NA
