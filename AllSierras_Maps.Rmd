...
#HOOK UP THE COLOR WITH THE FREAKING HEX DCODE and the goddman rastern umber goddammit

bivmap_simple = bivmapQ %>% 
  mutate(color = ifelse(fireResilienceAll < 4,"neither",
                       ifelse(fireResilienceAll > 4 & fireResilienceAll >0,"carbon",
