...
watershedboundaries_csv2 <- st_drop_geometry(WatershedBoundaries)
write.csv(watershedboundaries_csv2, "watershedboundaries_csv2.csv", row.names = TRUE)
```
...
B#
"
scatter <- s + ndc_selection + fire_selection + 
