...
##Apply to watersheds
```{r}
WatershedBoundaries$npixels <- exact_extract(fireExtract, WatershedBoundaries, 'count')
...
ndcplot <- ggplot() +
   # geom_sf(data = background, fill = "#dcdcdc", lwd = 0.1)+
    geom_sf(data = ndc_cty, fill = "#b0b0b0", lwd = 0.1, alpha = 0.5 ) +
    scale_color_manual(values=palette_new)+
    theme_minimal()+
...
```{r}
#intersect
ndc_ws <- st_intersection(WatershedBoundaries,ndc_cty)

ndcplot <- ggplot() +
    geom_sf(data = ndc_ws, fill = "#dcdcdc", lwd = 0.1)+
    geom_sf(data = ndc_cty, fill = "#b0b0b0", lwd = 0.1, alpha = 0.5 ) +
    scale_color_manual(values=palette_new)+
    theme_minimal()+
    ggtitle(expression(paste("NDC by County"))) +
