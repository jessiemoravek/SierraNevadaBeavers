...
###Percent Dam Capacity in Easements
```{r}
d <- sum(DamCap_Blue_GAP12$oCC_EX)
e <- sum(DamCap_Blue$oCC_EX)


percentDamCapacity_Blue_InGAP12 <- d/e
...
###Percent Dam Capacity in Easements
```{r}
f <- sum(DamCap_RestOpp_GAP12$oCC_EX)
g <- sum(DamCap_RestOpp$oCC_EX)


percentDamCapacity_RestOpp_GAP12 <- f/g
