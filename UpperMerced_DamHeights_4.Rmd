...
image(lon, lat, elevation)#Thats upside down
...
damvol <- rvol
damvol.df <- as.matrix(t(damvol), wide=T) #Converted your raster to a matrix. Using the raster as-is is problematic as it uses the whole thing for every iteration of the loop instead of the specific cell you're interested in
