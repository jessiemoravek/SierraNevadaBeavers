...
boundingBox2 <- st_transform(boundingBox2, 4326)
...
damCapacity2 <- st_transform(damCapacity2, 4326)
saveRDS(damCapacity2,"damCapacity2")
```
...
boundingBox_tealalbers <- st_transform(boundingBox2, 3310)
#Check if sf object is in metric CRS (i.e. projected)
st_is_longlat(boundingBox_tealalbers)
#st_is_longlat returns "False" which means that the object is in a metric CRS

#CRS 3310 is in units of meters (see here https://epsg.io/3310)
grid_spacing <- 1000 

grid3 <- st_make_grid(boundingBox_tealalbers, square = T, cellsize = c(grid_spacing, grid_spacing)) %>% # the grid, covering bounding box
  st_sf()
...
grid_wgs84 <- st_transform(grid3, 4326)
dim(grid_wgs84)
