...
map_b4 <- ggplot(data_long4, aes(x = HUCID_num, y = percentage, fill = variable)) +
  ...
  theme(axis.text.x = element_text(face = c('plain', 'plain','plain','plain','plain','bold','plain','plain','bold','bold','bold','bold','plain','plain','plain','plain','plain','plain','plain','plain','plain','plain','plain','plain','plain','bold','bold','bold','plain','plain','plain')))+
  theme(legend.position = "none")
